...
public class UtilV5 {
	...
	private static final Set<Long> perfectSquareSet = new HashSet<Long>();
	private static final Set<Long> nonPerfectSquareSet = new HashSet<Long>();
	...
	public static boolean isPerfectSquare(long n) {
		if (nonPerfectSquareSet.contains(n)){
			return false;
		}
		if (perfectSquareSet.contains(n)){
			return true;
		}
		...
		if (longSquareRoot * longSquareRoot == n) {
			perfectSquareSet.add(n);
			return true;
		} 
		
		nonPerfectSquareSet.add(n);		
		return false;
	}
